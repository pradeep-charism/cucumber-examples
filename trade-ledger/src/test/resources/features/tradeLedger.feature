Feature: Trade ledger
  ...
  Scenario Outline: Buy a trade
   Given User starts with his wallet amount of $5000
    When User buys a <Quantity> units of <Instrument> each costing $<Unit Price>
    Then It costs the User $<Total Price>
    Then The balance in User wallet is $<Wallet Remaining>
    Examples:
